...
public class IngredientAdapter extends RecyclerView.Adapter<IngredientAdapter.RecipeViewHolder> {
    ...
    public List<IngredientModel> exampleListFull;
    Context context;

    public IngredientAdapter(List<IngredientModel> exampleListFull, Context context)
    {
    ...
    public void onBindViewHolder(RecipeViewHolder holder, final int position) {
        ...
        holder.tv.setText(exampleListFull.get(position).getIngredient());
